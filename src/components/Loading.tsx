...
export const Loading: React.FC<Props> = ({ isLoading = true, children }) => {
    return <section className={isLoading ? 'm-auto' : ''}>
        {isLoading ?
            <center onTransitionEnd={(e) => e.currentTarget.classList.toggle('hidden')} role="status" className={`table`}>
