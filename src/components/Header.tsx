...
export default function Header() {
    ...
    return <header className="mt-3 md:mt-5">
        <div className="table md:mb-1">
            ...
            <div className="text-sm align-middle table-cell pl-3 text-slate-400 font-['Kanit'] md:text-base md:pl-8">
                <h6>Version {socketProvider?.currentVersion}</h6>
                {socketProvider?.isConnected ? <h6>Status: <span className='text-blue-400'>Connected</span></h6> : <h6>Status: <span className="text-rose-400"> &nbsp;Disconnected</span></h6>}
